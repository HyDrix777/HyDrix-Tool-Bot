...
from plugins.tool import SearchYTS, SearchAnime, Search1337x, SearchPirateBay
...
@Client.on_message(filters.command("torran"))
async def torran_handler(_, message: Message):
    try:
